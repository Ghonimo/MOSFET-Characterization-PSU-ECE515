...
% Plotting
figure
semilogy(V_GS_subthreshold, I_D_subthreshold, 'b', 'LineWidth', 1.5) % Line plot
hold on
scatter(V_GS_subthreshold, log10(I_D_subthreshold), 'MarkerEdgeColor', 'r') % Scatter plot
hold off
title('Logarithmic subthreshold characteristics (log(I_D) vs V_GS for V_DS = 2V)')
xlabel('V_GS (V)')
